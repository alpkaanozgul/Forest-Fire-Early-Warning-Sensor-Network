...
def generate_plots():
    ...
    axes[0].set_title(r'Histogram: Telemetry Interval (Exp, $\mu=30$s)')
    ...
    axes[0].set_title(r'Histogram: Temperature Reading (Normal, $\mu=25^\circ C$, $\sigma=3^\circ C$)')
    ...
    axes[0].set_title(r'Histogram: Gateway Service Time (Exp, $\mu=5$s)')
    axes[0].set_xlabel('Time (s)')
    axes[0].set_ylabel('Density')
    axes[0].legend()
