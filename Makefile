...
OBJS = \
    $O/src/fire/FireGen.o \
    $O/src/gateway/GatewayQueue.o \
    $O/src/sensor/SensorApp.o \
    $O/src/server/FireServer.o \
    $O/src/utils/RngUtils.o \
    $O/msg/AlarmMsg_m.o \
    $O/msg/TelemetryMsg_m.o
